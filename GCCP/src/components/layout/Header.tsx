...
export function Header() {
  ...
  return (
    <header className="h-16 border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md flex items-center px-6 justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-4">
        {/* Cost Meter */}
        <div className="h-8 px-3 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center text-sm font-medium">
          <span className="text-gray-500 dark:text-gray-400 mr-2">Session Cost:</span>
