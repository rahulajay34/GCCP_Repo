  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid gap-4">
        ...
        {generations.map((gen) => (
          <div key={gen.id} className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex justify-between items-center group">
