    ...
    <div className="max-w-5xl mx-auto">
      <div className="mb-12 text-center py-12">
        ...
        <div className="mt-8 flex justify-center gap-4">
          ...
          <button className="px-6 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 rounded-lg font-semibold transition-all">
            View History
          </button>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Generate comprehensive notes from transcripts with examples and diagrams.</p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Create structured assignments (MCQ, MSQ, Subjective) with answer keys.</p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Generate curiosity-inducing materials to prepare students for class.</p>
        </div>
      </div>
    </div>
  );
